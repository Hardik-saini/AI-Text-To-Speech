...
# Use this to add Cloudinary credentials as a Modal secret:
...
# $body = @{
# >>     prompt = "Hello from Chatterbox [chuckle]."
# >>     voice_key = "voices/system/cmrrhucm90001wwuwgkj4m9wn"
# >> } | ConvertTo-Json
# >>                                                                                                                       >> Invoke-RestMethod `                                                                                                   >>     -Uri "https://sainihardik1104--chatterbox-tts-chatterbox-serve.modal.run/generate" `                                 >>     -Method POST `                                                                                                    
# >>     -Headers @{ "X-Api-Key" = "hota-hai" } `
...
def test(
    ...
    voice_key: str = "voices/system/default",
